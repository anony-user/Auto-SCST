...
public class IntervalTree {
    ...
    public void insert(IntervalInterface interval) {
    ...
    public IntervalInterface search(IntervalInterface interval) {
    ...
    private boolean canOverlapOnLeftSide(IntervalInterface interval,
					 RbNode node) {
    ...
    private boolean canOverlapOnRightSide(IntervalInterface interval,
					 RbNode node) {
    ...
    public List searchAll(IntervalInterface interval) {
    ...
    private List _searchAll(IntervalInterface interval, RbNode node) {
	assert (! node.isNull());
    ...
    public IntervalInterface getInterval(RbNode node) {
	assert (node != null);
	assert (! node.isNull());

	assert (this.intervals.containsKey(node));

	return (IntervalInterface) this.intervals.get(node);
    }
