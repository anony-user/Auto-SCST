...
my $usage="usage: RPKMcorrelation.pl [ -read | -uniq ] [ -log ] [ -multiratio_cutoff <value> ] [ -o <output file> ] <geneRPKM 1, geneRPKM 2, ...>\n";

my ($reads,$uniq,$lg,$multiRatioCutOff,$output)=(0,0,0,0.96,"");
GetOptions ('read' => \$reads, 'uniq' => \$uniq, 'log' => \$lg, 'multiratio_cutoff=f' => \$multiRatioCutOff, 'o=s' => \$output) or die $usage;
