...
public class BufferCalculator {
	...
	public CirculinearBoundary2D createParallelBoundary(
		...
		return CirculinearContourArray2D.createCircu(parallelContours);
	}
	...
	public CirculinearContour2D createParallelContour(
		...
		return BoundaryPolyCirculinearCurve2D.createBoundary(parallelCurves, 
				contour.isClosed());
	}
	...
	public CirculinearContinuousCurve2D createContinuousParallel(
		...
		// curves
		return PolyCirculinearCurve2D.createPolyCirculinear(parallelCurves, curve.isClosed());
	}
	...
	public CirculinearDomain2D computeBuffer(
		...
		return new GenericCirculinearDomain2D(
				CirculinearContourArray2D.createCircu(contours2));
	}
	...
	private CirculinearContour2D convertCurveToBoundary (
		...
		if (curve.isClosed())
			return GenericCirculinearRing2D.createGeneric(curve.smoothPieces());
		
		return BoundaryPolyCirculinearCurve2D.createBoundary(curve.smoothPieces());
	}
